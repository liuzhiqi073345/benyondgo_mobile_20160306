...
function selectShipping(obj)
{
  ...
  var supportPickup = obj.attributes['supoortPickup'].value + 0;
  if (supportPickup == 0)
  {
...
function checkConsignee(frm)
{
  ...
  var msg = new Array();
  var err = false;
var id_card_err=IdentityCodeValid(frm.elements['id_card_num'].value)
if ( frm.elements['id_card_num'].value == '')
  {
    err = true;
    msg.push('身份证号不能为空');
  }
  else if(id_card_err!='ok')
  {
      err = true;
      msg.push(id_card_err);
  }
...
else if (!Utils.isMobile(frm.elements['mobile'].value))
