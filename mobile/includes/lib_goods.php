...
{
    $time = gmtime();
    $sql = 'SELECT g.*, c.measure_unit, b.brand_id, b.brand_name AS goods_brand, m.type_money AS bonus_money,type_name, ' .
...
function auction_info($act_id, $config = false)
{
    ...
    $auction['current_price_a'] = reset(explode('.', $auction['current_price']));
