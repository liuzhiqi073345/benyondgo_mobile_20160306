...
if (!empty($_SESSION['mobile_admin_id']))
{
    ...
    {
        if (strpos(',' . $_SESSION['mobile_action_list'] . ',', ',goods_manage,') === false && strpos(',' . $_SESSION['mobile_action_list'] . ',', ',virualcard,') === false && strpos(',' .
        $_SESSION['mobile_action_list'] . ',', ',article_manage,') === false)
        {
            $enable = false;
        }
        else
