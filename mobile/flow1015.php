...
elseif ($_REQUEST['step'] == 'done')
{
	...
	*/
    ...
    if ($_CFG['sms_order_placed'] == '1' && $_CFG['sms_shop_mobile'] != '')
    {
		...
		$content = "您有新订单,订单号:".$order['order_sn'].",收货人:".$order['consignee'].",电话:".$mobi."。【68ecshop】";
	...
	if ($_CFG['sms_order_payed'] == '1' && $_CFG['sms_shop_mobile'] != '' && $order['order_amount'] == 0)
	{
		...
		$content = "订单".$order['order_sn']."付款了。收货人:".$order['consignee'].",电话:".$mobi."。【68ecshop】";
	...
	@file_get_contents($autoUrl."/weixin/auto_do.php?type=1&is_order=1");
