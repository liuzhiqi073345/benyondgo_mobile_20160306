...
<div class="v_nav">
  <div class="vf_nav">
    <ul>
      ...
      <li><a href="flow.php"> <i class="vf_4" style=" width:28px;"></i> <span>购物车</span> <em class="global-nav__nav-shop-cart-num" id="ECS_CARTINFO" style=" margin-top:2px; margin-left:-1px;"><?php 
$k = array (
  'name' => 'cart_info',
);
