...
<title>【2罐装】德国Aptamil/爱他美婴幼儿配方奶粉Pre段*800g单罐179【预售】_德国爱他美_母婴专区_彼岸购保税店 </title>
...
location.href='share_goods.php?content=【2罐装】德国Aptamil/爱他美婴幼儿配方奶粉Pre段*800g单罐179【预售】&pics=../images/201509/goods_img/3191_G_1443420400276.jpg&gid=3191&url='+thisurl;
}
</script> 
<script type="text/javascript">
/*第一种形式 第二种形式 更换显示样式*/
  ...
  <div class="header">
    ...
    <div class="h-mid">
      <ul>
        ...
        <li><a href="goods_comment.php?act=list&id=3191" class="tab_head" id="goods_ka3">评价</a></li>
      </ul>
    </div>
    <div class="h-right">
      <aside class="top_bar">
...
<div class="goods_nav hid" id="menu">
    ...
    <form action="javascript:addToCart(3191)" method="post" id="purchase_form" name="ECS_FORMBUY">
    <div class="main" id="user_goods_ka_1" style="display:block;">
        <div class="banner">
  <div id="slider" class="slider">
    <ul id="sliderlist" class="sliderlist">
             <li style="float: left; display: block; width:100%;"><span><a  href="javacript:void(0)"><img title="" width="100%" src="../images/201509/goods_img/3191_P_1443420400180.jpg"></a></span></li>
           </ul>
...
var t2=new TouchSlider({id:'sliderlist', speed:600, timeout:6000, before:function(index){
		...
		as[active].className='active';
              ...
              <div class="info_dottm">
                <h3 class="name">【2罐装】德国Aptamil/爱他美婴幼儿配方奶粉Pre段*800g单罐179【预售】</h3>
              ...
              <ul class="price_dottm">
                ...
                <li>1人评价</li>
                <li style=" text-align:right">33人已付款</li>
              </ul>
            </div>
...
<div class="subNavBox" > 
<div class="subNav" style=" border:0;"><a href="pocking.php?id=3191"><strong>自提点</strong></a></div>
</div>
</div> 
    ...
    <div class="select_box">
                        ...
                        <li class="bd_bt">
                            ...
                            <div class="item1">
                             ...
                             <span class="ui-number">
                              ...
                              <input type="number" class="num" id="number" onblur="changePrice();" name="number" value="1" min="1" max="40" style=" text-align:center"/>
        ...
        <div class="select_box_btn">
            <a href="javascript:addToCart(3191);" class="add_cart_btn">确定</a>
            <a href="javascript:addToCart1(3191);" charset="buy_now_btn">确定</a>
        </div>
    </div>
    ...
    <div class="main" id="user_goods_ka_2" style="display:none">
      <div class="product_main" style=" margin-top:40px;">
        ...
        <div class="product_images product_desc" id="product_desc"><p><br/></p><p><img src="https://img.alicdn.com/imgextra/i1/35576911/TB2vHu6dVXXXXb1XpXXXXXXXXXX-35576911.jpg"/><img src="https://img.alicdn.com/imgextra/i1/35576911/TB2Hu5_dVXXXXbiXpXXXXXXXXXX-35576911.jpg"/><img src="https://img.alicdn.com/imgextra/i3/35576911/TB2kfTXdVXXXXX_XpXXXXXXXXXX-35576911.jpg"/><img src="https://img.alicdn.com/imgextra/i1/35576911/TB2FVPddVXXXXXFXpXXXXXXXXXX-35576911.jpg"/><img src="https://img.alicdn.com/imgextra/i2/35576911/TB22FTfdVXXXXXpXpXXXXXXXXXX-35576911.jpg"/><img src="https://img.alicdn.com/imgextra/i1/35576911/TB2yQvXdVXXXXXSXpXXXXXXXXXX-35576911.jpg"/><img src="https://img.alicdn.com/imgextra/i2/35576911/TB2pJnXdVXXXXaLXpXXXXXXXXXX-35576911.jpg"/><img src="https://img.alicdn.com/imgextra/i2/35576911/TB2L5q7dVXXXXbBXpXXXXXXXXXX-35576911.jpg"/><img src="https://img.alicdn.com/imgextra/i4/35576911/TB2AgfbdVXXXXadXpXXXXXXXXXX-35576911.jpg"/></p></div>
      </div>
          </div>
    
    <div class="tab_attrs tab_item hide" id="user_goods_ka_3" style="display:none;">
    	<script type="text/javascript" src="js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:3191;}554fcae493e564ee0dc75bdf2ebf94ca</div>
...
<div class="footer_nav">
 <ul> 
 	...
 	<li><a href="javascript:collect(3191)" id="favorite_add"><em class="goods_nav3"></em><span>收藏</span></a></li>
 </ul>
 <dl>
