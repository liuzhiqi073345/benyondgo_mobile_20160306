<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:79:"D:/wwwroot/beyondgo/wwwroot/mobile/themesmobile/68ecshopcom_mobile/category.dwt";i:1;s:89:"D:/wwwroot/beyondgo/wwwroot/mobile/themesmobile/68ecshopcom_mobile/library/goods_list.lbi";i:2;s:89:"D:/wwwroot/beyondgo/wwwroot/mobile/themesmobile/68ecshopcom_mobile/library/footer_nav.lbi";}s:7:"expires";i:1457184694;s:8:"maketime";i:1457181094;}<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8">
<meta name="format-detection" content="telephone=no">
<meta name="viewport" content="minimal-ui=yes,width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
<title>德国禧宝hipp_限时特卖_彼岸购保税店 </title>
...
<section class="_pre" >
  ...
  <section class="filtrate_term" id="product_sort" style="width: 100%;">
    <ul><li class=""><a href="category.php?category=600&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">最新</a></li><li class=""><a href="category.php?category=600&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=salenum&order=DESC#goods_list" >销量</a></li><li class="on"><a href="category.php?category=600&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=ASC#goods_list" >更新</a></li><li class=""><a href="category.php?category=600&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格<span class="arrow_up "></span><span class="arrow_down "></span></a></li><li class=""><a href="javascript:;" class="show_type show_list" >&nbsp;</a></li>
    </ul>
  </section>
  <section> 
    <script type="text/javascript">
var url = 'category.php?act=ajax&category=600&&display=grid&brand=&price_min=&price_max=&filter_attr=&page=1&sort=&order=';
$(function(){
    ...
    <ul class="filtrate_list" id="filter_category_list" style="display: block; -webkit-transform-origin: 0px 0px 0px; opacity: 1; -webkit-transform: scale(1, 1);">
      <li class="filtrate_list_li"> 
          ...
          <li class="filtrate_list_li"><a href="category.php?id=528" class="filtrate_list_li_a " style="padding-left:25px"><span>限时特卖</span></a>
            <ul>
                            <li class="filtrate_list_li"><a href="category.php?id=595" class="filtrate_list_li_a " style="padding-left:45px;">新西兰面膜</a></li>
                            ...
                            <li class="filtrate_list_li"><a href="category.php?id=600" class="filtrate_list_li_a on" style="padding-left:45px;">德国禧宝hipp</a></li>
                          </ul>
          </li>
        </ul>
         </li>
