 ...
 * ============================================================================
 * $Author: derek $
 * $Id: auction.php 17217 2015-02-10 06:29:08Z derek $
 */
...
if ($_REQUEST['act'] == 'list')
{
	...
	$smarty->assign('wap_auction_ad',get_wap_advlist('wap拍卖幻灯广告', 4));  //wap首页幻灯广告位
 ...
 * @return  array
 */
function auction_list($size, $page, $type = false)
{
    $auction_list = array();
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
		...
		$auction['imgfile_c'] = $auction['act_imgfile'];
		$auction['act_imgfile'] = "data/actimg/" . $auction['act_imgfile'];
    ...
    if (empty($auction_list['under_way']))
    {
        $auction_list = $auction_list['finished'];
}
    else if (empty($auction_list['finished']))
    {
        $auction_list = $auction_list['under_way'];
    }
    else
    {
